...
export class Player {
  ...
  init(url) {
    // 检查window.new265webjs是否存在
    if (typeof window.new265webjs !== 'function') {
      console.error('h265web.js library not loaded. Please check if the script files are properly included.');
      return;
    }
